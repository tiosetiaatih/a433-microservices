...
docker build -t karsajobs-ui:latest /Users/tiosetia/Documents/Dicoding/Microservices/Kubernetes/project-final/a433-microservices
echo " "
...
docker tag karsajobs-ui:latest ghcr.io/tiosetiaatih/karsajobs-ui:latest
echo " "
...
docker push ghcr.io/tiosetiaatih/karsajobs-ui:latest
echo " "
